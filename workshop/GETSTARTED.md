...
3. Go to [Get Cluster](https://get-cluster.mybluemix.net/) web page and enter your IBM ID (the email you used to sign up) and the lab key `thinkibm`.
4. Select `US-South` for the region.
